...
public class DashboardService {
    ...
    public List<HackathonsByLocationResponse> hackathonsByLocation() {
        return eventRepository.countHackathonsByLocation().stream()
                .map(item -> new HackathonsByLocationResponse(
                        item.getLocation(),
                        item.getHackathonCount()))
                .toList();
    }

    public List<String> locations() {
        return LocationConstants.ALLOWED_LOCATIONS;
    }
